...
- Preserve a frame's own variable bindings (padding, radius, stroke, etc.) when converting it into a component with `create_component`; previously only child-level bindings survived.
